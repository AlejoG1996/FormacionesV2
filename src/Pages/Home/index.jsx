        ...
        <div className="absolute inset-0 z-10 mx-0 max-w-none overflow-hidden">
          <div className="absolute top-0 left-1/2 -ml-152 h-100 w-325 dark:mask-[linear-gradient(white,transparent)]">
            ...
            <svg
              ...
              aria-hidden="true"
              className="absolute top-0 left-1/2 -ml-76 w-278.25 fill-white blur-[26px] dark:fill-zinc-900"
            >
            ...
            <div className="flex flex-col lg:flex-row w-full items-center justify-center gap-6 sm:gap-8 lg:gap-10 xl:gap-12 py-8 lg:py-12 ">
              ...
              <div className="w-full lg:w-[55%] flex items-center justify-center lg:justify-start z-30">
                <div className="flex flex-col w-full max-w-full px-4 lg:px-0">
                  ...
                  <h1 className="bg-gradient-to-br from-gray-600 to-gray-900 dark:from-white dark:to-zinc-500 bg-clip-text text-transparent font-bold tracking-tight leading-none text-center lg:text-left -mt-1 -ml-1 text-[16vw] sm:text-6xl md:text-6xl lg:text-7xl xl:text-8xl">
                    LOGITRANS
                  </h1>
                </div>
              </div>
        ...
        <div className="w-[95%] mx-auto py-4">
          <div className="flex flex-col items-center justify-center gap-3 text-center">
            ...
            <p className="text-sm text-zinc-600 dark:text-zinc-400 font-light">
              © {new Date().getFullYear()} LOGITRANS. Todos los derechos
              reservados.
            </p>
